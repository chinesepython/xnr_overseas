...
sys.path.append('/home/xnr_overseas/')

from util_tools.global_utils import fb_xnr_flow_text_index_name_pre, es_xnr_2, fb_xnr_flow_text_index_type
from xnr_spider.facebook.fb_operate import Operation

from util_tools.utils import fb_save_to_fans_follow_ES, fb_xnr_user_no2uid
from util_tools.time_utils import ts2datetime
