...
from fb_tweet_func import fb_publish, fb_retweet, fb_comment, fb_like
    ...
    while 1:    
        ...
        if tweet_params:
            ...
            # 评论
                ...
                print "facebook publish retweet =========================================================================channel = facebook operate_type = comment"
            ...
            # 喜欢
            elif channel == "facebook" and operate_type == "like":
                print "facebook publish like  =========================================================================channel = facebook operate_type = like"
                ...
                print account_name, password, _id, uid, channel, operate_type
                send_email_to('80617252@qq.com', 'will publish account_name is{}'.format(account_name))
                try:
                    mark = fb_like(account_name, password, _id, uid)
                except Exception as e:
                    print e
                    send_email_to('80617252@qq.com', '/home/xnr_overseas/xnr/timed_python_files/fb_operate_timer.py/like'.format(e))
