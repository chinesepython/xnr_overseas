...
from fb_tweet_func import fb_publish, fb_retweet
        ...
        if tweet_params:
            ...
            if channel == "facebook" and operate_type == "publish":
                ...
                try:
                    ...
                    print e
                    send_email_to('80617252@qq.com', '/home/xnr_overseas/xnr/timed_python_files/fb_operate_timer.py/publish'.format(account_name))
                ...
                try:
                    ...
                    print e
                    send_email_to('80617252@qq.com', '/home/xnr_overseas/xnr/timed_python_files/fb_operate_timer.py/retweet'.format(account_name))
